...
import (
	...
	"github.com/hsartoris-bard/machine/commands"
	"github.com/hsartoris-bard/machine/commands/mcndirs"
	"github.com/hsartoris-bard/machine/drivers/amazonec2"
	"github.com/hsartoris-bard/machine/drivers/azure"
	"github.com/hsartoris-bard/machine/drivers/digitalocean"
	"github.com/hsartoris-bard/machine/drivers/exoscale"
	"github.com/hsartoris-bard/machine/drivers/generic"
	"github.com/hsartoris-bard/machine/drivers/google"
	"github.com/hsartoris-bard/machine/drivers/hyperv"
	"github.com/hsartoris-bard/machine/drivers/none"
	"github.com/hsartoris-bard/machine/drivers/openstack"
	"github.com/hsartoris-bard/machine/drivers/rackspace"
	"github.com/hsartoris-bard/machine/drivers/softlayer"
	"github.com/hsartoris-bard/machine/drivers/virtualbox"
	"github.com/hsartoris-bard/machine/drivers/vmwarefusion"
	"github.com/hsartoris-bard/machine/drivers/vmwarevcloudair"
	"github.com/hsartoris-bard/machine/drivers/vmwarevsphere"
	"github.com/hsartoris-bard/machine/libmachine/drivers/plugin"
	"github.com/hsartoris-bard/machine/libmachine/drivers/plugin/localbinary"
	"github.com/hsartoris-bard/machine/libmachine/log"
	"github.com/hsartoris-bard/machine/version"
